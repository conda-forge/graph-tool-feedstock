...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/graph-tool-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/graph-tool-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add graph-tool graph-tool-base
# for installing globally
pixi global install graph-tool graph-tool-base
```
...
It is possible to list all of the versions of `graph-tool` available on your platform:
...
```
pixi search graph-tool --channel conda-forge
```
